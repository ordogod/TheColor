...
@Composable
internal fun AutoProceedWithRandomizedColors(
    title: String,
    description: String,
    checked: Boolean,
...
@Composable
private fun AutoProceedWithRandomizedColorsPreview() {
    TheColorTheme {
        AutoProceedWithRandomizedColors(
            title = "Auto proceed with randomized colors",
            description = "Randomizing a color will automatically show Color Center.",
            checked = true,
            onCheckedChange = {},
        )
    }
